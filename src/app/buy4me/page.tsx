          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
            <Card className="p-3 sm:p-4">
              <div className="flex items-center gap-2">
                ...
                <div className="text-xs sm:text-sm font-medium">Active Requests</div>
              </div>
            ...
            <Card className="p-3 sm:p-4">
              <div className="flex items-center gap-2">
                ...
                <div className="text-xs sm:text-sm font-medium">Pending Payments</div>
              </div>
              <div className="mt-2 text-xl sm:text-2xl font-bold">2</div>
            </Card>
            <Card className="p-3 sm:p-4">
              <div className="flex items-center gap-2">
                <List className="h-4 w-4 text-muted-foreground" />
                <div className="text-xs sm:text-sm font-medium">Orders in Transit</div>
              </div>
            ...
            <Card className="p-3 sm:p-4">
              <div className="flex items-center gap-2">
                ...
                <div className="text-xs sm:text-sm font-medium">Completed Orders</div>
              </div>
              <div className="mt-2 text-xl sm:text-2xl font-bold">12</div>
            </Card>
          </div>
          ...
          <Tabs value={activeTab} onValueChange={handleTabChange} className="space-y-4">
            ...
            <div className="sm:hidden">
              <TabsList className="grid w-full grid-cols-3 gap-1">
                <TabsTrigger value="browse" className="flex items-center justify-center gap-1 text-xs">
                  <ShoppingBag className="h-4 w-4" />
                  <span>Browse</span>
                </TabsTrigger>
                <TabsTrigger value="requests" className="flex items-center justify-center gap-1 text-xs">
                  <List className="h-4 w-4" />
                  <span>Requests</span>
                </TabsTrigger>
                <TabsTrigger value="orders" className="flex items-center justify-center gap-1 text-xs">
                  <CreditCard className="h-4 w-4" />
                  <span>Orders</span>
                </TabsTrigger>
              </TabsList>
